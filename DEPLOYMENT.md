...
2. 打开 https://github.com/liyangting/share-files/settings/pages 。
3. 在 Build and deployment → Source 中选择 **GitHub Actions**。
4. 打开仓库 Actions，选择 Deploy documentation to GitHub Pages；如果首次运行失败，在启用 Pages 后点击 Run workflow 重新运行。
5. 工作流成功后访问 https://liyangting.github.io/share-files/ 。
...
- 本站路径为 /share-files/；改仓库名或绑定独立域名时，需要同步修改 base 和 favicon 的路径。
